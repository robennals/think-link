// Commented out because the latest Scala nightly breaks this code, and I'm not using it right now
...
//		tree.filterTree(x => x.yescount < 5 && x.nocount < 5)
	...
	def trainTree(tree : PrefixTree, entries : Seq[Array[String]], length : Int, action : WordInfo => Unit){
