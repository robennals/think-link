...
\begin{figure*}[tb]
	\begin{center}
	\includegraphics[width=18cm]{images/2by5_bigger.pdf}
...
We downloaded all text strings that matched each of our 54 patterns for all dates from October 1st 2009 to January 19th 2010, and for January 10th of every year from 2000 to 2010. This gave us a total of 6.1 million text strings, of which 3.6 million were identified by our classifier as being unambiguous disputable claims. This does not mean that there are 3.6 million distinct beliefs that are disputed; many of the claims in our corpus are repeating claims made elsewhere in the corpus.
...
Our data set currently includes approximately 3.6 million records. In the future we intend to expand this by several orders of magnitude.
