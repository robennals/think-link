...
Rather that searching for an arbitrary collection of known disputed claims, we found that we generated better templates by searching for claims that most documents disagee with (e.g. ``eskimos have many words for snow'') rather than claims that many people agree with (e.g. ``there is a God''). If many people agree that a claim is true then many of the patterns that we find will not be patterns that indicate that the claim is disputed. 
