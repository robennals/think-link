...
\additionalauthors{Whoever else wants to help out with the paper. Let me know.}
...
% 	\caption{Dispute Finder connects claims to each other and to web snippets}
% 	\label{summarygraph}
% 	\end{center}
% \end{figure}
...
% FactCheck updates infrequently enough that we have been able to manually add its disputed claims to Dispute Finder as they appear.
