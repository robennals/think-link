...
\begin{figure}[tb]
	\begin{center}
	\includegraphics[width=6cm]{pictures/popup_abortion.png}
...
The biggest problem that Dispute Finder has right now is that its coverage is not very high. Both our database of disputed claims, and the number of snippets that we highlight that make each disputed claim

In its current state, it is unlikely that a user will see a snippet highlighted that makes a claim that they did 
