...
\additionalauthors{Tye Rattenbury and Tad Hirsch, Intel Research Principles and Practices,\texttt{[tye.l.rattenbury,tad.hirsch]@intel.com}}
...
\bibitem{Bouvin2000}
Niels~Olof Bouvin.
\newblock {Augmenting the Web through Open Hypermedia}.
\newblock {\em Phd Thesis, University of Aarhus}, 2000.

\bibitem{Conklin1987a}
Jeff Conklin and Michael~L Begeman.
\newblock {gIBIS: A Hypertext Tool for Team Design Deliberation}.
\newblock In {\em Hypertext}, 1987.

\bibitem{Braz}
R.~De~Salvo~Braz, R.~Girju, V.~Punyakanok, D.~Roth, and M.~Sammons.
\newblock {An inference model for semantic entailment in natural language}.
\newblock In {\em Artifical Intelligence}, volume~20. Springer, 2005.

\bibitem{Diakopoulos2008}
Nicholas Diakopoulos and Irfan Essa.
\newblock {An Annotation Model for Making Sense of Information Quality in
  Online Video}.
\newblock In {\em Pragmatic Web}, 2008.

\bibitem{Dinu2009}
Georgiana Dinu and Rui Wang.
\newblock {Inference Rules and their Application to Recognizing Textual
  Entailment}.
\newblock {\em Computational Linguistics}, pages 211--219, 2009.

\bibitem{Etzioni2008}
Oren Etzioni, Michele Banko, Stephen Soderland, and Daniel~S Weld.
\newblock {Open information Extraction from the Web}.
\newblock {\em Communications of the ACM}, 51, 2008.
...
\newblock {TRELLIS: An interactive tool for capturing information analysis and
  decision making}.
...
\newblock {Towards Content Trust of Web Resources}.
\newblock In {\em WWW}, pages 565--574, 2006.

\bibitem{Glickman2005}
O.~Glickman, I.~Dagan, and M.~Koppel.
\newblock {A probabilistic classification approach for lexical textual
  entailment}.
...
\newblock {The Structure of Collaborative Tagging Systems}.
\newblock {\em Journal of Information Science}, 2006.

\bibitem{Gordon1997}
Thomas~F Gordon and Nikos Karacapilidis.
\newblock {The Zeno Argumentation Framework}.
...
\newblock {\em {Manufacturing Consent: The Political Economy of the Mass
  Media}}.
\newblock Pantheon, 2002.

\bibitem{Hong2009}
L.~Hong and E.H. Chi.
\newblock {Annotate once, appear anywhere: collective foraging for snippets of
  interest using paragraph fingerprinting}.
\newblock In {\em CHI}. ACM New York, NY, USA, 2009.

\bibitem{Isenmann1997}
Severin Isenmann and Wolf~D Reuter.
\newblock {IBIS - a Convincing Concept . . . But a Lousy Instrument?}
\newblock In {\em Designing Interactive Systems (DIS)}, 1997.

\bibitem{Jijkoun2006}
Valentin Jijkoun and Maarten~De Rijke.
\newblock {Recognizing Textual Entailment: Is Word Similarity Enough?}
\newblock In {\em Machine Learning Challenges}, 2006.

\bibitem{Koivunen2001}
Jose Kahan and Marja-Ritta Koivunen.
\newblock {Annotea: an open RDF infrastructure for shared Web annotations}.
\newblock In {\em WWW}, volume~39, 2002.

\bibitem{Kim2009}
Jong~Wook Kim.
\newblock {Ef cient Overlap and Content Reuse Detection in Blogs and Online
  News Articles}.
\newblock In {\em WWW}, 2009.

\bibitem{Kittur2008}
Aniket Kittur and Robert~E Kraut.
\newblock {Harnessing the Wisdom of Crowds in Wikipedia: Quality Through
  Coordination}.
\newblock {\em CSCW}, pages 37--46, 2008.

\bibitem{Kolak2008}
Okan Kolak and Bill~N Schilit.
\newblock {Generating Links by Mining Quotations}.
...
\bibitem{Manjou2008}
Farhad Manjou.
\newblock {\em {True Enough: Learning to Live in a Post-Fact Society}}.
\newblock Wiley, 2008.

\bibitem{Marlow2006}
Cameron Marlow, Mor Naaman, Danah Boyd, and Marc Davis.
\newblock {HT06, Tagging Paper, Taxonomy, Flickr, Academic Article, To Read}.
\newblock In {\em Hypertext}, 2006.

\bibitem{Olsen2004}
Dan~R Olsen, Trent Taufer, and Jerry~Alan Fails.
\newblock {ScreenCrayons: Annotating Anything}.
...
\newblock {NewsCube: Delivering Multiple Aspects of News to Mitigate Media
  Bias}.
\newblock In {\em CHI}. Information Today, 2009.

\bibitem{PewResearch2008}
Pew Research.
\newblock {The Pew Research Center Biennial News Consumption Survey}, 2008.

\bibitem{Ritter}
Alan Ritter, Doug Downey, Stephen Soderland, and Oren Etzioni.
\newblock {It’s a Contradiction—No, it’s Not: A Case Study using
...
\newblock {Compendium: Making Meetings into Knowledge Events}.
\newblock In {\em Knowledge Technologies}, 2001.

\bibitem{Sereno2004}
Bertrand Sereno, Simon Buckingham, and Enrico Motta.
\newblock {Semi-Automatic Annotation of Contested Knowledge on the World Wide
  Web}.
\newblock {\em WWW}, 2004.

\bibitem{Sereno2005}
Bertrand Sereno, Buckingham Shum, and Enrico Motta.
\newblock {ClaimSpotter: an Environment to Support Sensemaking with Knowledge
  Triples}.
...
\newblock {Effectively using syntax for recognizing false entailment}.
\newblock In {\em Human Language Technology}, Morristown, NJ, USA, 2006.
  Association for Computational Linguistics.

\bibitem{Theobald2008}
M.~Theobald, J.~Siddharth, and A.~Paepcke.
\newblock {Spotsigs: robust and efficient near duplicate detection in large web
  collections}.
\newblock In {\em SIGIR}. ACM, 2008.

\bibitem{Wiil1996}
Uffe~Kock Wiil and John~J Leggett.
\newblock {The HyperDisco Approach to Open Hypermedia Systems}.
